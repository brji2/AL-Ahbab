        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('testers.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">المختبرون</span>
                </a>
            </li>
            <li>
                <a href="{{ route('institutes.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">المعاهد</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('groups.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">المدرسون</span>
                </a>
            </li>
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Sign In</span> <span
